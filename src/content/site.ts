...
export const signatureIntro =
  "dots-project의 시작은 거의 항상 클로드 교육입니다. 1시간 입문이 본인 서비스 구현으로, 단발 기업 워크숍이 통합 시스템 구축으로, 매주 1:1 코칭이 조직 단위 교육으로 — 들어가는 입구의 폭은 다르지만 모두 다음 단계로 이어집니다.";

export const signatureCases: SignatureCase[] = [
  {
    index: "I",
    category: "1시간 입문이 본인 손에 쥐는 도구로",
    field: "AI 처음 시작하시는 분께",
    title: "Claude 입문 1:1 — 1시간에 본인 업무 한 가지를 실제로 돌리기",
    lead:
      "AI를 처음 깔아본 분이 와도 1시간 안에 본인 업무 한 가지를 실제로 돌려보고 갑니다. '쓸 줄 안다'가 아니라 '내 일에 박았다'까지. 여기서 시작해 본인 서비스 구현·확장으로 이어진 분들이 여러 분 있습니다.",
    client: "소상공인 · 1인 사업자 · AI 입문자",
    format: "1:1 · 1회 1시간 · 본인 노트북으로 실습",
    built: [
      "본인 업무 자료 그대로 — 가공 없이 그 자리에서 실습",
      "AI 도구 설치부터 첫 자동화 흐름까지 한 호흡으로",
      "끝나고 가져갈 프롬프트·설정·매뉴얼 패키지",
      "혼자 막혀도 풀 수 있는 자가 진단 가이드",
    ],
    impact: [
      "1시간 만에 본인 업무 한 가지 실제로 자동화 완료",
      "AI '쓰는 법'이 아니라 '내 일에 박는 법'을 손에 쥐고 감",
      "여기서 시작해 본인 서비스 구현으로 이어진 케이스 다수",
    ],
    funnel: "1시간 입문 → 본인 서비스 구현으로",
  },
  {
    index: "II",
    ...
    client: "외식 프랜차이즈 D사 (흑돼지·고깃집 브랜드)",
